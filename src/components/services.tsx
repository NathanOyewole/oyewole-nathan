...
const services = [
    ...
    },
    {
        ...
        description: "Developing cross-platform mobile applications and software solutions that deliver seamless user experiences across different devices.",
        icon: Smartphone,
        category: "Mobile"
    },
    {
            ...
            <div className="max-w-7xl mx-auto relative">
                ...
                >
                    ...
                    <p className="text-[#FFFFFF99] text-base md:text-l ">
                        Specialized in cooking & getting cooked.
                    </p>
                </motion.div>
