        ...
        <div className="flex flex-col items-start flex-1 md:flex md:flex-row md:gap-10 md:items-center lg:flex lg:flex-row lg:items-center lg:gap-x-12 lg:justify-between">
          <div>
            <div className="gradientText">
              <h1>
                Creative Frontend Engineer<span>.</span>
              </h1>
            </div>
            ...
            >
              <p className="max-w-[310px]">
                I&#39;m Nathan Oyewole, 18, with 2+ Years of experience. Started coding in 2023, specializing in web development,
                app development.
              </p>
            ...
            <div className="mt-[35px] md:mt-[65px] flex justify-start items-center  gap-[26px] md:gap-[40px]">
              <motion.a
                href="https://x.com/NathanOyewole"
                target="_blank"
                rel="noreferrer"
                whileTap={{ scale: 1.1 }}
              ...
              <motion.a
                href="https://www.instagram.com/gamerlaz0"
                target="_blank"
                rel="noreferrer"
                whileTap={{ scale: 1.1 }}
                whileHover={{ scale: 0.99 }}
              ...
              <motion.a
                href="https://ng.linkedin.com/in/NathanOyewole"
                target="_blank"
                rel="noreferrer"
                whileTap={{ scale: 1.1 }}
                whileHover={{ scale: 0.99 }}
